  ...
  <div>
    ...
    <transition>
      <div class="sidebar" v-if="isShowing">
        <ul class="sidebar__menu">
          ...
          <li
            class="sidebar__menu--link sidebar__menu--firstlink"
          ...
          <li class="sidebar__menu--link" @click="isShowing = false">
            <router-link
              ...
              class="sidebar__menu--router"
              >User Requests</router-link
            >
          </li>
          <li
            class="sidebar__menu--link"
            v-if="
              this.$store.state.tokenHolder || this.$store.state.boardMember
            "
            @click="isShowing = false"
          >
            <router-link
          ...
          <li class="sidebar__menu--link" @click="isShowing = false">
            <router-link :to="{ name: 'ico' }" class="sidebar__menu--router"
              >ICO</router-link
            >
          </li>
          <li class="sidebar__menu--link" @click="isShowing = false">
            <router-link :to="{ name: 'about' }" class="sidebar__menu--router"
              >About</router-link
            >
          </li>
        </ul>
    ...
    <transition>
      <div
        ...
        v-if="isShowing"
        @click="$parent.$emit('toggleSidebar')"
      ></div>
    </transition>
  </div>
</template>
